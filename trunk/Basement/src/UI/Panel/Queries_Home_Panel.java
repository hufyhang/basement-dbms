 ...
 * @author hangfeifei
 */
public class Queries_Home_Panel extends UI.Panel.Panel_Template {

    private String current_database_queries = null;

    /** Creates new form Tables_Home_Panel */
    public Queries_Home_Panel() {
        initComponents();
    }

    public Queries_Home_Panel( String database ) {
        this();
        this.getQueries( database );
    }
    ...
    private void initComponents() {
        ...
        List_Queries = new javax.swing.JList();
        jSeparator3 = new javax.swing.JSeparator();
        jScrollPane2 = new javax.swing.JScrollPane();
        Query_Document = new javax.swing.JTable();
        ...
        Button_Query_Create.setText("Create Query in SQL View...");

        jButton2.setText("Use Wizard to Create Query...");
        ...
        List_Queries.setSelectionMode(javax.swing.ListSelectionModel.SINGLE_INTERVAL_SELECTION);
        jScrollPane1.setViewportView(List_Queries);

        jSeparator3.setOrientation(javax.swing.SwingConstants.VERTICAL);

        Query_Document.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane2.setViewportView(Query_Document);
    ...
    protected void getQueries( String databaseQueries ) {
        this.current_database_queries = databaseQueries + "/Queries";
        this.List_Queries.removeAll();
        ArrayList list = new ArrayList<String>();
        File dir = new File( this.current_database_queries );
        ...
        this.List_Queries.setListData( data );
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JButton Button_Query_Create;
    private javax.swing.JList List_Queries;
    private javax.swing.JTable Query_Document;
